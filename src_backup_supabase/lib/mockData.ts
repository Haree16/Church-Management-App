...
export const DEMO_USERS: DemoUserOption[] = [
  {
    ...
    email: 'admin@gracecitychennai.org',
    role: 'church_admin',
    name: 'Samuel Rajan',
  ...
  },
  {
    ...
    email: 'pastor@gracecitychennai.org',
    role: 'pastor',
    name: 'Rev. Dr. Paul Joseph',
    title: 'Senior Pastor',
  ...
  },
  {
    ...
    email: 'worship@gracecitychennai.org',
  ...
  },
  {
    ...
    email: 'groups@gracecitychennai.org',
    role: 'group_leader',
    name: 'Esther Rani',
    title: 'Care Groups Leader',
    avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80',
    phone: '+91 98400 45678',
  },
  {
    id: 'u0000000-0000-0000-0000-000000000006',
    email: 'volunteer@gracecitychennai.org',
    role: 'volunteer',
    name: 'Joshua Philip',
  ...
  },
  {
    ...
    email: 'member@gracecitychennai.org',
    role: 'member',
    name: 'Grace Anitha',
    title: 'Church Member',
